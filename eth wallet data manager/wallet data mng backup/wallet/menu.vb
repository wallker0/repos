...
Module menu
    ...
    Function main1()
        ...
        While index = 1
            ...
            write(p.wbtc, white, black, 4, 0)
            write("R$ " & Math.Round(p.btc * p.wbtc, 2), white, black, 5, 0)
            write(days2() & " days", white, black, 7, 0)
            write("R$ " & Math.Round(sumv2() * p.btc, 2) & " total", white, black, 8, 0)
            ...
            Select Case Console.ReadLine()
                ...
                Case "set pwr"
                    epwr()
                Case "view btc price", "view price"
                    vbtc()
